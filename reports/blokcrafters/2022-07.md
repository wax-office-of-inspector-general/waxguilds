...
+ Mynifties IOS & Android app has been live for 1 month now in both Google Play store & IOS app store. Download & check out the app here 
...
- For our forward looking roadmap for MyNifties: We are continuing development to improve MyNifties so it is up to par with other NFT portfolio trackers on WAX & hope that over this next rating period we can stand as equals with the competition. (Tokenhead, Tokengamer) You can keep up to date with our next MyNifties Release via our Twitter https://twitter.com/mynifties
