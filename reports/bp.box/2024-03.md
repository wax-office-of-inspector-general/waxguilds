...
### <ins>Noteworthy</ins>
*[...Describe issues you faced last month and if any noteworthy update/upgrade of hardware/software happened.]*
"Last month we experienced an issue in WAX blindbox: We need to balance between Sign-up points and trade volume points, so that making people trade more while still giving some easy airdrops for randomly players"
