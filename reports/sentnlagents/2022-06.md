...
- **Security Audit:** This month we completed a security audits for EOSUSA & Greeneosio



### Milestones for the following 1-2 months:

- Complete another 2 Guild security audits. 
...
* Updated to frontend to include results for full or partial history solutions for hyperion, for mainnet and testnet.



### Backend

* Updated the backend to verify whether a hyperion is running a full or partial history, for mainnet and testnet.
