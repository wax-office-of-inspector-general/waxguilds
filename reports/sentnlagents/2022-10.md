...
- **Security Audit:** This month we completed a security audits for Ledgerwise
...
* Updated our requests to a non standard user-agent
* Updated our docker DNS settings, which was causing a DNS resolution error, failing us from reading certain guild JSON files. 
...
Updated the script to accomodate indices with count of 0.
https://github.com/eosrio/hyperion-history-api/pull/126
