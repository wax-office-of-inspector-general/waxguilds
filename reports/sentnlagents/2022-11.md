...
- **Security Audit:** This month we completed a security audits for Blokcraters
...
* Changes to how we obtain information from hyperion testnet nodes. 
* Started turning all the code into a class based system, to help reduce code length.
