...
- **Security Audit:** This month we completed a security audits for Pink.gg
...
* Loads of changes to introduce a more class based system.
* Increased peformance due to class based system
* Allowed for multi chain use
